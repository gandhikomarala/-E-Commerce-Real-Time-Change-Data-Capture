...
/**
 * Enterprise CDC Lakehouse Model: EmbeddedSqliteChangeJournalModel.
 * Maintains SQLite rollback journal for local retail kiosk transactions.
 */
public class EmbeddedSqliteChangeJournalModel implements Serializable {
    ...
    public EmbeddedSqliteChangeJournalModel() {
    ...
    public EmbeddedSqliteChangeJournalModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        EmbeddedSqliteChangeJournalModel that = (EmbeddedSqliteChangeJournalModel) o;
    ...
    public String toString() {
        return "EmbeddedSqliteChangeJournalModel{" +
