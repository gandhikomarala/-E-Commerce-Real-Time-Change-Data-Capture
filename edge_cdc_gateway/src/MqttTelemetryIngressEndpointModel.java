...
/**
 * Enterprise CDC Lakehouse Model: MqttTelemetryIngressEndpointModel.
 * Consumes IoT RFID pallet scanner events over lightweight MQTT protocol.
 */
public class MqttTelemetryIngressEndpointModel implements Serializable {
    ...
    public MqttTelemetryIngressEndpointModel() {
    ...
    public MqttTelemetryIngressEndpointModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        MqttTelemetryIngressEndpointModel that = (MqttTelemetryIngressEndpointModel) o;
    ...
    public String toString() {
        return "MqttTelemetryIngressEndpointModel{" +
