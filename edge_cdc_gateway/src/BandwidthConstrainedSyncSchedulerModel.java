...
/**
 * Enterprise CDC Lakehouse Model: BandwidthConstrainedSyncSchedulerModel.
 * Schedules large CDC data syncs during off-peak retail store hours.
 */
public class BandwidthConstrainedSyncSchedulerModel implements Serializable {
    ...
    public BandwidthConstrainedSyncSchedulerModel() {
    ...
    public BandwidthConstrainedSyncSchedulerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        BandwidthConstrainedSyncSchedulerModel that = (BandwidthConstrainedSyncSchedulerModel) o;
    ...
    public String toString() {
        return "BandwidthConstrainedSyncSchedulerModel{" +
