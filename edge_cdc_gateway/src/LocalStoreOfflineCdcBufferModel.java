...
/**
 * Enterprise CDC Lakehouse Model: LocalStoreOfflineCdcBufferModel.
 * Buffers local point-of-sale terminal mutations during internet uplink outages.
 */
public class LocalStoreOfflineCdcBufferModel implements Serializable {
    ...
    public LocalStoreOfflineCdcBufferModel() {
    ...
    public LocalStoreOfflineCdcBufferModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        LocalStoreOfflineCdcBufferModel that = (LocalStoreOfflineCdcBufferModel) o;
    ...
    public String toString() {
        return "LocalStoreOfflineCdcBufferModel{" +
