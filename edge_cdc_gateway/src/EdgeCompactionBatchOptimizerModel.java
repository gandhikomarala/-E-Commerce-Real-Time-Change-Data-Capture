...
/**
 * Enterprise CDC Lakehouse Model: EdgeCompactionBatchOptimizerModel.
 * Performs micro-compaction of Parquet rows on edge gateway hardware.
 */
public class EdgeCompactionBatchOptimizerModel implements Serializable {
    ...
    public EdgeCompactionBatchOptimizerModel() {
    ...
    public EdgeCompactionBatchOptimizerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        EdgeCompactionBatchOptimizerModel that = (EdgeCompactionBatchOptimizerModel) o;
    ...
    public String toString() {
        return "EdgeCompactionBatchOptimizerModel{" +
