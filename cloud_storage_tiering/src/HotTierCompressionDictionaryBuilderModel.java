...
/**
 * Enterprise CDC Lakehouse Model: HotTierCompressionDictionaryBuilderModel.
 * Builds shared zstandard compression dictionaries for hot mutation tables.
 */
public class HotTierCompressionDictionaryBuilderModel implements Serializable {
    ...
    public HotTierCompressionDictionaryBuilderModel() {
    ...
    public HotTierCompressionDictionaryBuilderModel(String mutationId, String sourceTable, String operationType,
    ...
    public void setScd2Current(boolean scd2Current) { this.isScd2Current = scd2Current; }
    ...
    public boolean equals(Object o) {
        ...
        HotTierCompressionDictionaryBuilderModel that = (HotTierCompressionDictionaryBuilderModel) o;
    ...
    public String toString() {
        return "HotTierCompressionDictionaryBuilderModel{" +
