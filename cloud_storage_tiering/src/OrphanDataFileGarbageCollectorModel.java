...
/**
 * Enterprise CDC Lakehouse Model: OrphanDataFileGarbageCollectorModel.
 * Identifies unreferenced Parquet data files across Iceberg snapshots.
 */
public class OrphanDataFileGarbageCollectorModel implements Serializable {
    ...
    public OrphanDataFileGarbageCollectorModel() {
    ...
    public OrphanDataFileGarbageCollectorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OrphanDataFileGarbageCollectorModel that = (OrphanDataFileGarbageCollectorModel) o;
    ...
    public String toString() {
        return "OrphanDataFileGarbageCollectorModel{" +
