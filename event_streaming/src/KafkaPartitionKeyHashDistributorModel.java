...
/**
 * Enterprise CDC Lakehouse Model: KafkaPartitionKeyHashDistributorModel.
 * Distributes order mutations by customer_id hash to preserve strict per-entity ordering.
 */
public class KafkaPartitionKeyHashDistributorModel implements Serializable {
    ...
    public KafkaPartitionKeyHashDistributorModel() {
    ...
    public KafkaPartitionKeyHashDistributorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        KafkaPartitionKeyHashDistributorModel that = (KafkaPartitionKeyHashDistributorModel) o;
    ...
    public String toString() {
        return "KafkaPartitionKeyHashDistributorModel{" +
