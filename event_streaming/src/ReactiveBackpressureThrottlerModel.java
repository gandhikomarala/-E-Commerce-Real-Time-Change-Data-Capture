...
/**
 * Enterprise CDC Lakehouse Model: ReactiveBackpressureThrottlerModel.
 * Throttles ingestion rate when downstream Iceberg S3 commit rate falls behind.
 */
public class ReactiveBackpressureThrottlerModel implements Serializable {
    ...
    public ReactiveBackpressureThrottlerModel() {
    ...
    public ReactiveBackpressureThrottlerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ReactiveBackpressureThrottlerModel that = (ReactiveBackpressureThrottlerModel) o;
    ...
    public String toString() {
        return "ReactiveBackpressureThrottlerModel{" +
