...
/**
 * Enterprise CDC Lakehouse Model: ExactlyOnceTransactionalProducerModel.
 * Coordinates two-phase commit Kafka producer transactions with Flink state checkpoints.
 */
public class ExactlyOnceTransactionalProducerModel implements Serializable {
    ...
    public ExactlyOnceTransactionalProducerModel() {
    ...
    public ExactlyOnceTransactionalProducerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ExactlyOnceTransactionalProducerModel that = (ExactlyOnceTransactionalProducerModel) o;
    ...
    public String toString() {
        return "ExactlyOnceTransactionalProducerModel{" +
