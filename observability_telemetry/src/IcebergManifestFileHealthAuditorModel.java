...
/**
 * Enterprise CDC Lakehouse Model: IcebergManifestFileHealthAuditorModel.
 * Scans for dangling manifest files, corrupted metadata snapshots, and unreferenced data files.
 */
public class IcebergManifestFileHealthAuditorModel implements Serializable {
    ...
    public IcebergManifestFileHealthAuditorModel() {
    ...
    public IcebergManifestFileHealthAuditorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        IcebergManifestFileHealthAuditorModel that = (IcebergManifestFileHealthAuditorModel) o;
    ...
    public String toString() {
        return "IcebergManifestFileHealthAuditorModel{" +
