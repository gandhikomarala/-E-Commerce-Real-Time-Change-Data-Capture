...
/**
 * Enterprise CDC Lakehouse Model: OpenTelemetryDistributedTraceSpanCollectorModel.
 * Traces end-to-end latency span from PostgreSQL commit to Iceberg query readiness.
 */
public class OpenTelemetryDistributedTraceSpanCollectorModel implements Serializable {
    ...
    public OpenTelemetryDistributedTraceSpanCollectorModel() {
    ...
    public OpenTelemetryDistributedTraceSpanCollectorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OpenTelemetryDistributedTraceSpanCollectorModel that = (OpenTelemetryDistributedTraceSpanCollectorModel) o;
    ...
    public String toString() {
        return "OpenTelemetryDistributedTraceSpanCollectorModel{" +
