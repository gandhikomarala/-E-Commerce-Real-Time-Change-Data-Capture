...
/**
 * Enterprise CDC Lakehouse Model: GrafanaDashboardMetadataConfiguratorModel.
 * Automates Grafana dashboard JSON model generation and alert rule provisioning.
 */
public class GrafanaDashboardMetadataConfiguratorModel implements Serializable {
    ...
    public GrafanaDashboardMetadataConfiguratorModel() {
    ...
    public GrafanaDashboardMetadataConfiguratorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        GrafanaDashboardMetadataConfiguratorModel that = (GrafanaDashboardMetadataConfiguratorModel) o;
    ...
    public String toString() {
        return "GrafanaDashboardMetadataConfiguratorModel{" +
