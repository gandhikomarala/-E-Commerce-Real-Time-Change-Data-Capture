...
/**
 * Enterprise CDC Lakehouse Model: PrometheusMetricsExporterEndpointModel.
 * Exposes OpenMetrics prometheus metrics for mutation rate, LSN lag, and compaction duration.
 */
public class PrometheusMetricsExporterEndpointModel implements Serializable {
    ...
    public PrometheusMetricsExporterEndpointModel() {
    ...
    public PrometheusMetricsExporterEndpointModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PrometheusMetricsExporterEndpointModel that = (PrometheusMetricsExporterEndpointModel) o;
    ...
    public String toString() {
        return "PrometheusMetricsExporterEndpointModel{" +
