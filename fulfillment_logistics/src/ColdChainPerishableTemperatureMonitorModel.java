...
/**
 * Enterprise CDC Lakehouse Model: ColdChainPerishableTemperatureMonitorModel.
 * Tracks IoT cold-chain sensor telemetry for temperature-sensitive grocery deliveries.
 */
public class ColdChainPerishableTemperatureMonitorModel implements Serializable {
    ...
    public ColdChainPerishableTemperatureMonitorModel() {
    ...
    public ColdChainPerishableTemperatureMonitorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ColdChainPerishableTemperatureMonitorModel that = (ColdChainPerishableTemperatureMonitorModel) o;
    ...
    public String toString() {
        return "ColdChainPerishableTemperatureMonitorModel{" +
