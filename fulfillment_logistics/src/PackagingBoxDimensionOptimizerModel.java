...
/**
 * Enterprise CDC Lakehouse Model: PackagingBoxDimensionOptimizerModel.
 * Recommends optimal carton sizes to minimize dimensional weight (DIM weight) carrier surcharges.
 */
public class PackagingBoxDimensionOptimizerModel implements Serializable {
    ...
    public PackagingBoxDimensionOptimizerModel() {
    ...
    public PackagingBoxDimensionOptimizerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PackagingBoxDimensionOptimizerModel that = (PackagingBoxDimensionOptimizerModel) o;
    ...
    public String toString() {
        return "PackagingBoxDimensionOptimizerModel{" +
