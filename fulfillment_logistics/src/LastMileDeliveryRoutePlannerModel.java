...
/**
 * Enterprise CDC Lakehouse Model: LastMileDeliveryRoutePlannerModel.
 * Optimizes vehicle routing problem (VRP) with time windows for last-mile delivery vans.
 */
public class LastMileDeliveryRoutePlannerModel implements Serializable {
    ...
    public LastMileDeliveryRoutePlannerModel() {
    ...
    public LastMileDeliveryRoutePlannerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        LastMileDeliveryRoutePlannerModel that = (LastMileDeliveryRoutePlannerModel) o;
    ...
    public String toString() {
        return "LastMileDeliveryRoutePlannerModel{" +
