...
/**
 * Enterprise CDC Lakehouse Model: AutomatedSortingConveyorTelemetrySyncModel.
 * Synchronizes high-speed warehouse sorting conveyor diverter telemetry with order tracking.
 */
public class AutomatedSortingConveyorTelemetrySyncModel implements Serializable {
    ...
    public AutomatedSortingConveyorTelemetrySyncModel() {
    ...
    public AutomatedSortingConveyorTelemetrySyncModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AutomatedSortingConveyorTelemetrySyncModel that = (AutomatedSortingConveyorTelemetrySyncModel) o;
    ...
    public String toString() {
        return "AutomatedSortingConveyorTelemetrySyncModel{" +
