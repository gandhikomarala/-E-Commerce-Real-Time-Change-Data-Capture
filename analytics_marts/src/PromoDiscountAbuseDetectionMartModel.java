...
/**
 * Enterprise CDC Lakehouse Model: PromoDiscountAbuseDetectionMartModel.
 * Identifies users creating multiple accounts to exploit welcome promo codes.
 */
public class PromoDiscountAbuseDetectionMartModel implements Serializable {
    ...
    public PromoDiscountAbuseDetectionMartModel() {
    ...
    public PromoDiscountAbuseDetectionMartModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PromoDiscountAbuseDetectionMartModel that = (PromoDiscountAbuseDetectionMartModel) o;
    ...
    public String toString() {
        return "PromoDiscountAbuseDetectionMartModel{" +
