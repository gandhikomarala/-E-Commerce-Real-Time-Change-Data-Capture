...
/**
 * Enterprise CDC Lakehouse Model: MerchantPayoutSettlementLedgerModel.
 * Calculates net merchant payouts, commission deductions, and rolling reserve withholdings.
 */
public class MerchantPayoutSettlementLedgerModel implements Serializable {
    ...
    public MerchantPayoutSettlementLedgerModel() {
    ...
    public MerchantPayoutSettlementLedgerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        MerchantPayoutSettlementLedgerModel that = (MerchantPayoutSettlementLedgerModel) o;
    ...
    public String toString() {
        return "MerchantPayoutSettlementLedgerModel{" +
