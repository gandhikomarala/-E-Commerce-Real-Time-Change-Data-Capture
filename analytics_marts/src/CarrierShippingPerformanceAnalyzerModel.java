...
/**
 * Enterprise CDC Lakehouse Model: CarrierShippingPerformanceAnalyzerModel.
 * Benchmarks FedEx, UPS, and DHL on-time delivery rates and transit delay distributions.
 */
public class CarrierShippingPerformanceAnalyzerModel implements Serializable {
    ...
    public CarrierShippingPerformanceAnalyzerModel() {
    ...
    public CarrierShippingPerformanceAnalyzerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CarrierShippingPerformanceAnalyzerModel that = (CarrierShippingPerformanceAnalyzerModel) o;
    ...
    public String toString() {
        return "CarrierShippingPerformanceAnalyzerModel{" +
