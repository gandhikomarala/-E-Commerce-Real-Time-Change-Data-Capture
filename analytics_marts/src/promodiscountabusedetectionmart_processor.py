"""
Real-Time Python CDC Processing Worker: PromoDiscountAbuseDetectionMart.
...
logger = logging.getLogger("PromoDiscountAbuseDetectionMartProcessor")

class PromoDiscountAbuseDetectionMartProcessor:
    ...
    def process_cdc_event(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[PromoDiscountAbuseDetectionMart] Processed mutation {mutation_id} for {table}: Layer={layer}, Latency={elapsed_ms:.2f}ms")
