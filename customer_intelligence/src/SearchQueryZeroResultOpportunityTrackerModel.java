...
/**
 * Enterprise CDC Lakehouse Model: SearchQueryZeroResultOpportunityTrackerModel.
 * Identifies trending search queries returning zero product results for catalog expansion.
 */
public class SearchQueryZeroResultOpportunityTrackerModel implements Serializable {
    ...
    public SearchQueryZeroResultOpportunityTrackerModel() {
    ...
    public SearchQueryZeroResultOpportunityTrackerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SearchQueryZeroResultOpportunityTrackerModel that = (SearchQueryZeroResultOpportunityTrackerModel) o;
    ...
    public String toString() {
        return "SearchQueryZeroResultOpportunityTrackerModel{" +
