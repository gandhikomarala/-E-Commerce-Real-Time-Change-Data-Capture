...
/**
 * Enterprise CDC Lakehouse Model: ReviewSpamFakeReviewClassifierModel.
 * Identifies incentivized or automated bot product reviews using stylistic and timing heuristics.
 */
public class ReviewSpamFakeReviewClassifierModel implements Serializable {
    ...
    public ReviewSpamFakeReviewClassifierModel() {
    ...
    public ReviewSpamFakeReviewClassifierModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ReviewSpamFakeReviewClassifierModel that = (ReviewSpamFakeReviewClassifierModel) o;
    ...
    public String toString() {
        return "ReviewSpamFakeReviewClassifierModel{" +
