...
/**
 * Enterprise CDC Lakehouse Model: PredictiveLifetimeValueRegressorModel.
 * Gradient boosted regression model predicting 365-day customer net revenue contribution.
 */
public class PredictiveLifetimeValueRegressorModel implements Serializable {
    ...
    public PredictiveLifetimeValueRegressorModel() {
    ...
    public PredictiveLifetimeValueRegressorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PredictiveLifetimeValueRegressorModel that = (PredictiveLifetimeValueRegressorModel) o;
    ...
    public String toString() {
        return "PredictiveLifetimeValueRegressorModel{" +
