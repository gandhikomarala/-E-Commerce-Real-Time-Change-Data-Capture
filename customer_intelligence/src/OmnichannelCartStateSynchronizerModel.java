...
/**
 * Enterprise CDC Lakehouse Model: OmnichannelCartStateSynchronizerModel.
 * Synchronizes shopping cart state across mobile app, web desktop, and in-store POS kiosks.
 */
public class OmnichannelCartStateSynchronizerModel implements Serializable {
    ...
    public OmnichannelCartStateSynchronizerModel() {
    ...
    public OmnichannelCartStateSynchronizerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OmnichannelCartStateSynchronizerModel that = (OmnichannelCartStateSynchronizerModel) o;
    ...
    public String toString() {
        return "OmnichannelCartStateSynchronizerModel{" +
