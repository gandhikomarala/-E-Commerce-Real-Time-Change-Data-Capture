...
/**
 * Enterprise CDC Lakehouse Model: ChurnProbabilityEarlyWarningDetectorModel.
 * Flags customers whose session frequency has declined by >40% over consecutive 14-day windows.
 */
public class ChurnProbabilityEarlyWarningDetectorModel implements Serializable {
    ...
    public ChurnProbabilityEarlyWarningDetectorModel() {
    ...
    public ChurnProbabilityEarlyWarningDetectorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ChurnProbabilityEarlyWarningDetectorModel that = (ChurnProbabilityEarlyWarningDetectorModel) o;
    ...
    public String toString() {
        return "ChurnProbabilityEarlyWarningDetectorModel{" +
