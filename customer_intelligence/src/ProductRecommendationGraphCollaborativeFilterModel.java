...
/**
 * Enterprise CDC Lakehouse Model: ProductRecommendationGraphCollaborativeFilterModel.
 * Item-to-item collaborative filtering model serving real-time 'Frequently Bought Together' SKUs.
 */
public class ProductRecommendationGraphCollaborativeFilterModel implements Serializable {
    ...
    public ProductRecommendationGraphCollaborativeFilterModel() {
    ...
    public ProductRecommendationGraphCollaborativeFilterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ProductRecommendationGraphCollaborativeFilterModel that = (ProductRecommendationGraphCollaborativeFilterModel) o;
    ...
    public String toString() {
        return "ProductRecommendationGraphCollaborativeFilterModel{" +
