...
/**
 * Enterprise CDC Lakehouse Model: CustomerCohortRfmSegmentationModelModel.
 * Computes streaming Recency, Frequency, and Monetary (RFM) quintile scores for every customer.
 */
public class CustomerCohortRfmSegmentationModelModel implements Serializable {
    ...
    public CustomerCohortRfmSegmentationModelModel() {
    ...
    public CustomerCohortRfmSegmentationModelModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CustomerCohortRfmSegmentationModelModel that = (CustomerCohortRfmSegmentationModelModel) o;
    ...
    public String toString() {
        return "CustomerCohortRfmSegmentationModelModel{" +
