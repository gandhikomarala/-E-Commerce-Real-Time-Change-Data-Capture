...
/**
 * Enterprise CDC Lakehouse Model: SnowflakeDynamicTableStreamRefresherModel.
 * Refreshes Snowflake dynamic tables based on Iceberg metadata snapshot notifications.
 */
public class SnowflakeDynamicTableStreamRefresherModel implements Serializable {
    ...
    public SnowflakeDynamicTableStreamRefresherModel() {
    ...
    public SnowflakeDynamicTableStreamRefresherModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SnowflakeDynamicTableStreamRefresherModel that = (SnowflakeDynamicTableStreamRefresherModel) o;
    ...
    public String toString() {
        return "SnowflakeDynamicTableStreamRefresherModel{" +
