...
/**
 * Enterprise CDC Lakehouse Model: ClickHouseReplacingMergeTreeCdcBridgeModel.
 * Streams CDC row mutations directly into ClickHouse ReplacingMergeTree tables.
 */
public class ClickHouseReplacingMergeTreeCdcBridgeModel implements Serializable {
    ...
    public ClickHouseReplacingMergeTreeCdcBridgeModel() {
    ...
    public ClickHouseReplacingMergeTreeCdcBridgeModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ClickHouseReplacingMergeTreeCdcBridgeModel that = (ClickHouseReplacingMergeTreeCdcBridgeModel) o;
    ...
    public String toString() {
        return "ClickHouseReplacingMergeTreeCdcBridgeModel{" +
