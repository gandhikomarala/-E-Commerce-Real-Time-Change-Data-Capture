...
/**
 * Enterprise CDC Lakehouse Model: BigQueryBigLakeIcebergCatalogFederatorModel.
 * Exposes Iceberg table metadata to Google Cloud BigQuery BigLake catalog.
 */
public class BigQueryBigLakeIcebergCatalogFederatorModel implements Serializable {
    ...
    public BigQueryBigLakeIcebergCatalogFederatorModel() {
    ...
    public BigQueryBigLakeIcebergCatalogFederatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        BigQueryBigLakeIcebergCatalogFederatorModel that = (BigQueryBigLakeIcebergCatalogFederatorModel) o;
    ...
    public String toString() {
        return "BigQueryBigLakeIcebergCatalogFederatorModel{" +
