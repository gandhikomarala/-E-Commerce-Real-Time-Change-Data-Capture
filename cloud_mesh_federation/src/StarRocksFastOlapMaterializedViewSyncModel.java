...
/**
 * Enterprise CDC Lakehouse Model: StarRocksFastOlapMaterializedViewSyncModel.
 * Synchronizes real-time StarRocks materialized view cubes over Iceberg tables.
 */
public class StarRocksFastOlapMaterializedViewSyncModel implements Serializable {
    ...
    public StarRocksFastOlapMaterializedViewSyncModel() {
    ...
    public StarRocksFastOlapMaterializedViewSyncModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        StarRocksFastOlapMaterializedViewSyncModel that = (StarRocksFastOlapMaterializedViewSyncModel) o;
    ...
    public String toString() {
        return "StarRocksFastOlapMaterializedViewSyncModel{" +
