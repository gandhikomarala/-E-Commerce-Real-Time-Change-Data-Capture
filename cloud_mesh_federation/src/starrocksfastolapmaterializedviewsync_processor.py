"""
Real-Time Python CDC Processing Worker: StarRocksFastOlapMaterializedViewSync.
...
logger = logging.getLogger("StarRocksFastOlapMaterializedViewSyncProcessor")

class StarRocksFastOlapMaterializedViewSyncProcessor:
    ...
    def process_cdc_event(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[StarRocksFastOlapMaterializedViewSync] Processed mutation {mutation_id} for {table}: Layer={layer}, Latency={elapsed_ms:.2f}ms")
