...
/**
 * Enterprise CDC Lakehouse Model: MultiCurrencyGrossSettlementReconcilerModel.
 * Reconciles multi-currency checkout authorizations against acquirer settlement batches.
 */
public class MultiCurrencyGrossSettlementReconcilerModel implements Serializable {
    ...
    public MultiCurrencyGrossSettlementReconcilerModel() {
    ...
    public MultiCurrencyGrossSettlementReconcilerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        MultiCurrencyGrossSettlementReconcilerModel that = (MultiCurrencyGrossSettlementReconcilerModel) o;
    ...
    public String toString() {
        return "MultiCurrencyGrossSettlementReconcilerModel{" +
