"""
Real-Time Python CDC Processing Worker: MultiCurrencyGrossSettlementReconciler.
...
logger = logging.getLogger("MultiCurrencyGrossSettlementReconcilerProcessor")

class MultiCurrencyGrossSettlementReconcilerProcessor:
    ...
    def process_cdc_event(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[MultiCurrencyGrossSettlementReconciler] Processed mutation {mutation_id} for {table}: Layer={layer}, Latency={elapsed_ms:.2f}ms")
