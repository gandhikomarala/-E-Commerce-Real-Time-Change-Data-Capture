...
/**
 * Enterprise CDC Lakehouse Model: ShoppingBagAbandonmentRecoveryTriggerModel.
 * Identifies shopping cart mutations without corresponding checkout orders within 30-minute window.
 */
public class ShoppingBagAbandonmentRecoveryTriggerModel implements Serializable {
    ...
    public ShoppingBagAbandonmentRecoveryTriggerModel() {
    ...
    public ShoppingBagAbandonmentRecoveryTriggerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ShoppingBagAbandonmentRecoveryTriggerModel that = (ShoppingBagAbandonmentRecoveryTriggerModel) o;
    ...
    public String toString() {
        return "ShoppingBagAbandonmentRecoveryTriggerModel{" +
