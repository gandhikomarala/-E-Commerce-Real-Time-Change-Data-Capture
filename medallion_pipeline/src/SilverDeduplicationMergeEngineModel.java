...
/**
 * Enterprise CDC Lakehouse Model: SilverDeduplicationMergeEngineModel.
 * Performs primary-key deduplication and row-version resolution from Bronze CDC change stream.
 */
public class SilverDeduplicationMergeEngineModel implements Serializable {
    ...
    public SilverDeduplicationMergeEngineModel() {
    ...
    public SilverDeduplicationMergeEngineModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SilverDeduplicationMergeEngineModel that = (SilverDeduplicationMergeEngineModel) o;
    ...
    public String toString() {
        return "SilverDeduplicationMergeEngineModel{" +
