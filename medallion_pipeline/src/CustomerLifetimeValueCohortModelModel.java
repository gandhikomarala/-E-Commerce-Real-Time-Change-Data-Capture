...
/**
 * Enterprise CDC Lakehouse Model: CustomerLifetimeValueCohortModelModel.
 * Computes dynamic RFM (Recency, Frequency, Monetary) segmentation and CLV projections.
 */
public class CustomerLifetimeValueCohortModelModel implements Serializable {
    ...
    public CustomerLifetimeValueCohortModelModel() {
    ...
    public CustomerLifetimeValueCohortModelModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CustomerLifetimeValueCohortModelModel that = (CustomerLifetimeValueCohortModelModel) o;
    ...
    public String toString() {
        return "CustomerLifetimeValueCohortModelModel{" +
