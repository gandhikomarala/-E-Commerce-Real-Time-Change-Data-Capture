...
/**
 * Enterprise CDC Lakehouse Model: FlashSaleRevenueVelocityAggregatorModel.
 * Calculates tumbling 5-minute GMV, net checkout velocity, and merchant settlement accruals.
 */
public class FlashSaleRevenueVelocityAggregatorModel implements Serializable {
    ...
    public FlashSaleRevenueVelocityAggregatorModel() {
    ...
    public FlashSaleRevenueVelocityAggregatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        FlashSaleRevenueVelocityAggregatorModel that = (FlashSaleRevenueVelocityAggregatorModel) o;
    ...
    public String toString() {
        return "FlashSaleRevenueVelocityAggregatorModel{" +
