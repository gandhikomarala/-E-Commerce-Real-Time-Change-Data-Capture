...
/**
 * Enterprise CDC Lakehouse Model: OrderFulfillmentSlaBreachMonitorModel.
 * Tracks duration between ORDER_PLACED and WAREHOUSE_DISPATCHED against regional SLAs.
 */
public class OrderFulfillmentSlaBreachMonitorModel implements Serializable {
    ...
    public OrderFulfillmentSlaBreachMonitorModel() {
    ...
    public OrderFulfillmentSlaBreachMonitorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OrderFulfillmentSlaBreachMonitorModel that = (OrderFulfillmentSlaBreachMonitorModel) o;
    ...
    public String toString() {
        return "OrderFulfillmentSlaBreachMonitorModel{" +
