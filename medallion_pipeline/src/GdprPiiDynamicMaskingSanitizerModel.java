...
/**
 * Enterprise CDC Lakehouse Model: GdprPiiDynamicMaskingSanitizerModel.
 * Applies format-preserving tokenization and pseudonymization on customer PII database columns.
 */
public class GdprPiiDynamicMaskingSanitizerModel implements Serializable {
    ...
    public GdprPiiDynamicMaskingSanitizerModel() {
    ...
    public GdprPiiDynamicMaskingSanitizerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        GdprPiiDynamicMaskingSanitizerModel that = (GdprPiiDynamicMaskingSanitizerModel) o;
    ...
    public String toString() {
        return "GdprPiiDynamicMaskingSanitizerModel{" +
