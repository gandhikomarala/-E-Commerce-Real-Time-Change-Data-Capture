...
/**
 * Enterprise CDC Lakehouse Model: GoldScdType2HistoricalDimensionBuilderModel.
 * Maintains Slowly Changing Dimensions (SCD Type 2) tracking historical customer addresses and prices.
 */
public class GoldScdType2HistoricalDimensionBuilderModel implements Serializable {
    ...
    public GoldScdType2HistoricalDimensionBuilderModel() {
    ...
    public GoldScdType2HistoricalDimensionBuilderModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        GoldScdType2HistoricalDimensionBuilderModel that = (GoldScdType2HistoricalDimensionBuilderModel) o;
    ...
    public String toString() {
        return "GoldScdType2HistoricalDimensionBuilderModel{" +
