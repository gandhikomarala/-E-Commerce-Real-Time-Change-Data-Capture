...
/**
 * Enterprise CDC Lakehouse Model: DynamicPriceElasticityCurveEstimatorModel.
 * Estimates real-time price elasticity coefficient from continuous clickstream and purchase CDC events.
 */
public class DynamicPriceElasticityCurveEstimatorModel implements Serializable {
    ...
    public DynamicPriceElasticityCurveEstimatorModel() {
    ...
    public DynamicPriceElasticityCurveEstimatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DynamicPriceElasticityCurveEstimatorModel that = (DynamicPriceElasticityCurveEstimatorModel) o;
    ...
    public String toString() {
        return "DynamicPriceElasticityCurveEstimatorModel{" +
