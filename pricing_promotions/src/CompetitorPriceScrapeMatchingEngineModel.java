...
/**
 * Enterprise CDC Lakehouse Model: CompetitorPriceScrapeMatchingEngineModel.
 * Normalizes and matches competitor marketplace catalog prices using embedding similarity.
 */
public class CompetitorPriceScrapeMatchingEngineModel implements Serializable {
    ...
    public CompetitorPriceScrapeMatchingEngineModel() {
    ...
    public CompetitorPriceScrapeMatchingEngineModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CompetitorPriceScrapeMatchingEngineModel that = (CompetitorPriceScrapeMatchingEngineModel) o;
    ...
    public String toString() {
        return "CompetitorPriceScrapeMatchingEngineModel{" +
