...
/**
 * Enterprise CDC Lakehouse Model: CouponAbuseSyndicateVelocityDetectorModel.
 * Identifies bot syndicates generating disposable email accounts to exhaust single-use coupons.
 */
public class CouponAbuseSyndicateVelocityDetectorModel implements Serializable {
    ...
    public CouponAbuseSyndicateVelocityDetectorModel() {
    ...
    public CouponAbuseSyndicateVelocityDetectorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CouponAbuseSyndicateVelocityDetectorModel that = (CouponAbuseSyndicateVelocityDetectorModel) o;
    ...
    public String toString() {
        return "CouponAbuseSyndicateVelocityDetectorModel{" +
