...
/**
 * Enterprise CDC Lakehouse Model: TaxJurisdictionRateLookupCalculatorModel.
 * Calculates municipal, state, and national sales tax rates across 12,000+ US postal jurisdictions.
 */
public class TaxJurisdictionRateLookupCalculatorModel implements Serializable {
    ...
    public TaxJurisdictionRateLookupCalculatorModel() {
    ...
    public TaxJurisdictionRateLookupCalculatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        TaxJurisdictionRateLookupCalculatorModel that = (TaxJurisdictionRateLookupCalculatorModel) o;
    ...
    public String toString() {
        return "TaxJurisdictionRateLookupCalculatorModel{" +
