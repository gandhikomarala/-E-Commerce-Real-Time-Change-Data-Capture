...
/**
 * Enterprise CDC Lakehouse Model: LoyaltyRewardPointBurnAccrualLedgerModel.
 * Maintains double-entry ledger of customer loyalty reward points earned and redeemed.
 */
public class LoyaltyRewardPointBurnAccrualLedgerModel implements Serializable {
    ...
    public LoyaltyRewardPointBurnAccrualLedgerModel() {
    ...
    public LoyaltyRewardPointBurnAccrualLedgerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        LoyaltyRewardPointBurnAccrualLedgerModel that = (LoyaltyRewardPointBurnAccrualLedgerModel) o;
    ...
    public String toString() {
        return "LoyaltyRewardPointBurnAccrualLedgerModel{" +
