...
/**
 * Enterprise CDC Lakehouse Model: FraudScoreHighVelocityInterceptionTriggerModel.
 * Triggers immediate payment hold when customer places >5 orders in under 3 minutes.
 */
public class FraudScoreHighVelocityInterceptionTriggerModel implements Serializable {
    ...
    public FraudScoreHighVelocityInterceptionTriggerModel() {
    ...
    public FraudScoreHighVelocityInterceptionTriggerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        FraudScoreHighVelocityInterceptionTriggerModel that = (FraudScoreHighVelocityInterceptionTriggerModel) o;
    ...
    public String toString() {
        return "FraudScoreHighVelocityInterceptionTriggerModel{" +
