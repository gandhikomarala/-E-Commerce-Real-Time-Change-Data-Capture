...
/**
 * Enterprise CDC Lakehouse Model: RefundApprovedLedgerEntryTriggerModel.
 * Emits financial double-entry transaction when customer refund request is authorized.
 */
public class RefundApprovedLedgerEntryTriggerModel implements Serializable {
    ...
    public RefundApprovedLedgerEntryTriggerModel() {
    ...
    public RefundApprovedLedgerEntryTriggerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        RefundApprovedLedgerEntryTriggerModel that = (RefundApprovedLedgerEntryTriggerModel) o;
    ...
    public String toString() {
        return "RefundApprovedLedgerEntryTriggerModel{" +
