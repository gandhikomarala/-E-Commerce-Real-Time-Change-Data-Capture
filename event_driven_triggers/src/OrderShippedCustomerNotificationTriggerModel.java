...
/**
 * Enterprise CDC Lakehouse Model: OrderShippedCustomerNotificationTriggerModel.
 * Dispatches instant WhatsApp/SMS notification when order status mutates to SHIPPED.
 */
public class OrderShippedCustomerNotificationTriggerModel implements Serializable {
    ...
    public OrderShippedCustomerNotificationTriggerModel() {
    ...
    public OrderShippedCustomerNotificationTriggerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OrderShippedCustomerNotificationTriggerModel that = (OrderShippedCustomerNotificationTriggerModel) o;
    ...
    public String toString() {
        return "OrderShippedCustomerNotificationTriggerModel{" +
