...
/**
 * Enterprise CDC Lakehouse Model: DynamicDataMaskingRbacFilterModel.
 * Applies role-based column masking depending on querying user security clearance.
 */
public class DynamicDataMaskingRbacFilterModel implements Serializable {
    ...
    public DynamicDataMaskingRbacFilterModel() {
    ...
    public DynamicDataMaskingRbacFilterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DynamicDataMaskingRbacFilterModel that = (DynamicDataMaskingRbacFilterModel) o;
    ...
    public String toString() {
        return "DynamicDataMaskingRbacFilterModel{" +
