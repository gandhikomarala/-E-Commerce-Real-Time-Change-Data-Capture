...
/**
 * Enterprise CDC Lakehouse Model: EnvelopeEncryptionKmsClientModel.
 * Encrypts Parquet column chunks using AWS KMS / HashiCorp Vault DEK envelope encryption.
 */
public class EnvelopeEncryptionKmsClientModel implements Serializable {
    ...
    public EnvelopeEncryptionKmsClientModel() {
    ...
    public EnvelopeEncryptionKmsClientModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        EnvelopeEncryptionKmsClientModel that = (EnvelopeEncryptionKmsClientModel) o;
    ...
    public String toString() {
        return "EnvelopeEncryptionKmsClientModel{" +
