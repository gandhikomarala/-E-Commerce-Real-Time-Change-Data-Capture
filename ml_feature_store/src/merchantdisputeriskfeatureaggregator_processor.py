"""
Real-Time Python CDC Processing Worker: MerchantDisputeRiskFeatureAggregator.
...
logger = logging.getLogger("MerchantDisputeRiskFeatureAggregatorProcessor")

class MerchantDisputeRiskFeatureAggregatorProcessor:
    ...
    def process_cdc_event(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[MerchantDisputeRiskFeatureAggregator] Processed mutation {mutation_id} for {table}: Layer={layer}, Latency={elapsed_ms:.2f}ms")
