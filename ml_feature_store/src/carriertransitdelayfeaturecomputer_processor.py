"""
Real-Time Python CDC Processing Worker: CarrierTransitDelayFeatureComputer.
...
logger = logging.getLogger("CarrierTransitDelayFeatureComputerProcessor")

class CarrierTransitDelayFeatureComputerProcessor:
    ...
    def process_cdc_event(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[CarrierTransitDelayFeatureComputer] Processed mutation {mutation_id} for {table}: Layer={layer}, Latency={elapsed_ms:.2f}ms")
