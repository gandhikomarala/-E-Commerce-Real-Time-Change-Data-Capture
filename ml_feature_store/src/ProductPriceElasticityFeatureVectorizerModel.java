...
/**
 * Enterprise CDC Lakehouse Model: ProductPriceElasticityFeatureVectorizerModel.
 * Generates 30-day historical price elasticity feature vectors for dynamic pricing ML models.
 */
public class ProductPriceElasticityFeatureVectorizerModel implements Serializable {
    ...
    public ProductPriceElasticityFeatureVectorizerModel() {
    ...
    public ProductPriceElasticityFeatureVectorizerModel(String mutationId, String sourceTable, String operationType,
    ...
    public void setQualityValidated(boolean qualityValidated) { this.qualityValidated = qualityValidated; }

    public boolean isScd2Current() { return isScd2Current; }
    public void setScd2Current(boolean scd2Current) { this.scd2Current = scd2Current; }
    ...
    public boolean equals(Object o) {
        ...
        ProductPriceElasticityFeatureVectorizerModel that = (ProductPriceElasticityFeatureVectorizerModel) o;
    ...
    public String toString() {
        return "ProductPriceElasticityFeatureVectorizerModel{" +
