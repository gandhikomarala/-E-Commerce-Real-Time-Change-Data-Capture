...
/**
 * Enterprise CDC Lakehouse Model: CustomerRealTimeCheckoutPropensityScorerModel.
 * Computes real-time checkout propensity score based on in-session cart additions.
 */
public class CustomerRealTimeCheckoutPropensityScorerModel implements Serializable {
    ...
    public CustomerRealTimeCheckoutPropensityScorerModel() {
    ...
    public CustomerRealTimeCheckoutPropensityScorerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CustomerRealTimeCheckoutPropensityScorerModel that = (CustomerRealTimeCheckoutPropensityScorerModel) o;
    ...
    public String toString() {
        return "CustomerRealTimeCheckoutPropensityScorerModel{" +
