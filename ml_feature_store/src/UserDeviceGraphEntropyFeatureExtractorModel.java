...
/**
 * Enterprise CDC Lakehouse Model: UserDeviceGraphEntropyFeatureExtractorModel.
 * Extracts graph entropy and IP subnet sharing features for account security.
 */
public class UserDeviceGraphEntropyFeatureExtractorModel implements Serializable {
    ...
    public UserDeviceGraphEntropyFeatureExtractorModel() {
    ...
    public UserDeviceGraphEntropyFeatureExtractorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        UserDeviceGraphEntropyFeatureExtractorModel that = (UserDeviceGraphEntropyFeatureExtractorModel) o;
    ...
    public String toString() {
        return "UserDeviceGraphEntropyFeatureExtractorModel{" +
