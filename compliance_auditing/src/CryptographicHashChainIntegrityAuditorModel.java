...
/**
 * Enterprise CDC Lakehouse Model: CryptographicHashChainIntegrityAuditorModel.
 * Verifies SHA-256 hash chains across mutation logs to detect any unauthorized data tampering.
 */
public class CryptographicHashChainIntegrityAuditorModel implements Serializable {
    ...
    public CryptographicHashChainIntegrityAuditorModel() {
    ...
    public CryptographicHashChainIntegrityAuditorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CryptographicHashChainIntegrityAuditorModel that = (CryptographicHashChainIntegrityAuditorModel) o;
    ...
    public String toString() {
        return "CryptographicHashChainIntegrityAuditorModel{" +
