...
/**
 * Enterprise CDC Lakehouse Model: VertexOseriesTaxComplianceBridgeModel.
 * Integrates with Vertex O Series tax engine for B2B tax exemption certificates.
 */
public class VertexOseriesTaxComplianceBridgeModel implements Serializable {
    ...
    public VertexOseriesTaxComplianceBridgeModel() {
    ...
    public VertexOseriesTaxComplianceBridgeModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        VertexOseriesTaxComplianceBridgeModel that = (VertexOseriesTaxComplianceBridgeModel) o;
    ...
    public String toString() {
        return "VertexOseriesTaxComplianceBridgeModel{" +
