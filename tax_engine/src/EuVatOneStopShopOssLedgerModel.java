...
/**
 * Enterprise CDC Lakehouse Model: EuVatOneStopShopOssLedgerModel.
 * Maintains European Union VAT One-Stop Shop (OSS) quarterly tax return ledgers.
 */
public class EuVatOneStopShopOssLedgerModel implements Serializable {
    ...
    public EuVatOneStopShopOssLedgerModel() {
    ...
    public EuVatOneStopShopOssLedgerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        EuVatOneStopShopOssLedgerModel that = (EuVatOneStopShopOssLedgerModel) o;
    ...
    public String toString() {
        return "EuVatOneStopShopOssLedgerModel{" +
