...
/**
 * Enterprise CDC Lakehouse Model: UsStateEconomicNexusThresholdAuditorModel.
 * Monitors rolling 12-month sales volume and transaction count thresholds for state nexus.
 */
public class UsStateEconomicNexusThresholdAuditorModel implements Serializable {
    ...
    public UsStateEconomicNexusThresholdAuditorModel() {
    ...
    public UsStateEconomicNexusThresholdAuditorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        UsStateEconomicNexusThresholdAuditorModel that = (UsStateEconomicNexusThresholdAuditorModel) o;
    ...
    public String toString() {
        return "UsStateEconomicNexusThresholdAuditorModel{" +
