...
/**
 * Enterprise CDC Lakehouse Model: CrossDockingTransferRouteSolverModel.
 * Solves optimal direct cross-docking vehicle transfer schedules without intermediate warehousing.
 */
public class CrossDockingTransferRouteSolverModel implements Serializable {
    ...
    public CrossDockingTransferRouteSolverModel() {
    ...
    public CrossDockingTransferRouteSolverModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CrossDockingTransferRouteSolverModel that = (CrossDockingTransferRouteSolverModel) o;
    ...
    public String toString() {
        return "CrossDockingTransferRouteSolverModel{" +
