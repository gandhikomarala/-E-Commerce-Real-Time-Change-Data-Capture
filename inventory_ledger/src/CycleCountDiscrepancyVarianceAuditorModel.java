...
/**
 * Enterprise CDC Lakehouse Model: CycleCountDiscrepancyVarianceAuditorModel.
 * Audits continuous blind cycle count inventory variances against ERP ledger balances.
 */
public class CycleCountDiscrepancyVarianceAuditorModel implements Serializable {
    ...
    public CycleCountDiscrepancyVarianceAuditorModel() {
    ...
    public CycleCountDiscrepancyVarianceAuditorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CycleCountDiscrepancyVarianceAuditorModel that = (CycleCountDiscrepancyVarianceAuditorModel) o;
    ...
    public String toString() {
        return "CycleCountDiscrepancyVarianceAuditorModel{" +
