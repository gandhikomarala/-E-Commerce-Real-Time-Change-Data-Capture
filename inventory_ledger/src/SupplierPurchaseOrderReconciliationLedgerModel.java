...
/**
 * Enterprise CDC Lakehouse Model: SupplierPurchaseOrderReconciliationLedgerModel.
 * Reconciles incoming supplier ASNs (Advance Shipping Notices) with warehouse dock scans.
 */
public class SupplierPurchaseOrderReconciliationLedgerModel implements Serializable {
    ...
    public SupplierPurchaseOrderReconciliationLedgerModel() {
    ...
    public SupplierPurchaseOrderReconciliationLedgerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SupplierPurchaseOrderReconciliationLedgerModel that = (SupplierPurchaseOrderReconciliationLedgerModel) o;
    ...
    public String toString() {
        return "SupplierPurchaseOrderReconciliationLedgerModel{" +
