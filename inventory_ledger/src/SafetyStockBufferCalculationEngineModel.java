...
/**
 * Enterprise CDC Lakehouse Model: SafetyStockBufferCalculationEngineModel.
 * Computes dynamic safety stock levels based on lead time volatility and Poisson demand.
 */
public class SafetyStockBufferCalculationEngineModel implements Serializable {
    ...
    public SafetyStockBufferCalculationEngineModel() {
    ...
    public SafetyStockBufferCalculationEngineModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SafetyStockBufferCalculationEngineModel that = (SafetyStockBufferCalculationEngineModel) o;
    ...
    public String toString() {
        return "SafetyStockBufferCalculationEngineModel{" +
