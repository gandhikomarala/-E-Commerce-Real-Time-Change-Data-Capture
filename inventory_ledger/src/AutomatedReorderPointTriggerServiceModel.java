...
/**
 * Enterprise CDC Lakehouse Model: AutomatedReorderPointTriggerServiceModel.
 * Generates automated vendor purchase orders when inventory dips below dynamically calculated ROP.
 */
public class AutomatedReorderPointTriggerServiceModel implements Serializable {
    ...
    public AutomatedReorderPointTriggerServiceModel() {
    ...
    public AutomatedReorderPointTriggerServiceModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AutomatedReorderPointTriggerServiceModel that = (AutomatedReorderPointTriggerServiceModel) o;
    ...
    public String toString() {
        return "AutomatedReorderPointTriggerServiceModel{" +
