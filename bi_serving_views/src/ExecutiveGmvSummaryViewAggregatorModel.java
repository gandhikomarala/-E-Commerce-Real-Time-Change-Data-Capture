...
/**
 * Enterprise CDC Lakehouse Model: ExecutiveGmvSummaryViewAggregatorModel.
 * Pre-computes sub-second materialized views for C-suite gross merchandise value dashboards.
 */
public class ExecutiveGmvSummaryViewAggregatorModel implements Serializable {
    ...
    public ExecutiveGmvSummaryViewAggregatorModel() {
    ...
    public ExecutiveGmvSummaryViewAggregatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ExecutiveGmvSummaryViewAggregatorModel that = (ExecutiveGmvSummaryViewAggregatorModel) o;
    ...
    public String toString() {
        return "ExecutiveGmvSummaryViewAggregatorModel{" +
