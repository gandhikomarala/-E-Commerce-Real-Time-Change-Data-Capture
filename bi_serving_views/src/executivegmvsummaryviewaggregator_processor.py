"""
Real-Time Python CDC Processing Worker: ExecutiveGmvSummaryViewAggregator.
...
logger = logging.getLogger("ExecutiveGmvSummaryViewAggregatorProcessor")

class ExecutiveGmvSummaryViewAggregatorProcessor:
    ...
    def process_cdc_event(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[ExecutiveGmvSummaryViewAggregator] Processed mutation {mutation_id} for {table}: Layer={layer}, Latency={elapsed_ms:.2f}ms")
