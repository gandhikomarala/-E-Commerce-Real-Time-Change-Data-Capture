...
/**
 * Enterprise CDC Lakehouse Model: ProductCatalogSearchVectorIndexModel.
 * Maintains dense HNSW vector index of product embeddings for semantic visual search.
 */
public class ProductCatalogSearchVectorIndexModel implements Serializable {
    ...
    public ProductCatalogSearchVectorIndexModel() {
    ...
    public ProductCatalogSearchVectorIndexModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ProductCatalogSearchVectorIndexModel that = (ProductCatalogSearchVectorIndexModel) o;
    ...
    public String toString() {
        return "ProductCatalogSearchVectorIndexModel{" +
