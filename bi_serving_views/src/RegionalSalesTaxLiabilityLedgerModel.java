...
/**
 * Enterprise CDC Lakehouse Model: RegionalSalesTaxLiabilityLedgerModel.
 * Maintains accurate audit trails of collected state and municipal sales taxes.
 */
public class RegionalSalesTaxLiabilityLedgerModel implements Serializable {
    ...
    public RegionalSalesTaxLiabilityLedgerModel() {
    ...
    public RegionalSalesTaxLiabilityLedgerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        RegionalSalesTaxLiabilityLedgerModel that = (RegionalSalesTaxLiabilityLedgerModel) o;
    ...
    public String toString() {
        return "RegionalSalesTaxLiabilityLedgerModel{" +
