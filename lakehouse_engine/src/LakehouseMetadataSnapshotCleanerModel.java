...
/**
 * Enterprise CDC Lakehouse Model: LakehouseMetadataSnapshotCleanerModel.
 * Prunes expired metadata snapshots, manifest lists, and orphaned data files across S3 storage.
 */
public class LakehouseMetadataSnapshotCleanerModel implements Serializable {
    ...
    public LakehouseMetadataSnapshotCleanerModel() {
    ...
    public LakehouseMetadataSnapshotCleanerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        LakehouseMetadataSnapshotCleanerModel that = (LakehouseMetadataSnapshotCleanerModel) o;
    ...
    public String toString() {
        return "LakehouseMetadataSnapshotCleanerModel{" +
