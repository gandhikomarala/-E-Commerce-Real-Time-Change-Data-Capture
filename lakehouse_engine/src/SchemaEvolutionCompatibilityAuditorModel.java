...
/**
 * Enterprise CDC Lakehouse Model: SchemaEvolutionCompatibilityAuditorModel.
 * Validates forward and backward schema evolution across Lakehouse metadata snapshots.
 */
public class SchemaEvolutionCompatibilityAuditorModel implements Serializable {
    ...
    public SchemaEvolutionCompatibilityAuditorModel() {
    ...
    public SchemaEvolutionCompatibilityAuditorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SchemaEvolutionCompatibilityAuditorModel that = (SchemaEvolutionCompatibilityAuditorModel) o;
    ...
    public String toString() {
        return "SchemaEvolutionCompatibilityAuditorModel{" +
