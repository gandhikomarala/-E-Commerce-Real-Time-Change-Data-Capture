...
/**
 * Enterprise CDC Lakehouse Model: MinioObjectStorageCatalogManagerModel.
 * Manages S3-compatible MinIO object storage bucket life cycles, encryption at rest, and metadata manifests.
 */
public class MinioObjectStorageCatalogManagerModel implements Serializable {
    ...
    public MinioObjectStorageCatalogManagerModel() {
    ...
    public MinioObjectStorageCatalogManagerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        MinioObjectStorageCatalogManagerModel that = (MinioObjectStorageCatalogManagerModel) o;
    ...
    public String toString() {
        return "MinioObjectStorageCatalogManagerModel{" +
