...
/**
 * Enterprise CDC Lakehouse Model: ApacheIcebergPartitionWriterModel.
 * Writes ACID transactional Parquet files into Apache Iceberg table format with snapshot isolation.
 */
public class ApacheIcebergPartitionWriterModel implements Serializable {
    ...
    public ApacheIcebergPartitionWriterModel() {
    ...
    public ApacheIcebergPartitionWriterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ApacheIcebergPartitionWriterModel that = (ApacheIcebergPartitionWriterModel) o;
    ...
    public String toString() {
        return "ApacheIcebergPartitionWriterModel{" +
