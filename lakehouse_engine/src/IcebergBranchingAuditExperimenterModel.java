...
/**
 * Enterprise CDC Lakehouse Model: IcebergBranchingAuditExperimenterModel.
 * Manages Iceberg table branches and tags for zero-copy ML feature backtesting and audit rollbacks.
 */
public class IcebergBranchingAuditExperimenterModel implements Serializable {
    ...
    public IcebergBranchingAuditExperimenterModel() {
    ...
    public IcebergBranchingAuditExperimenterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        IcebergBranchingAuditExperimenterModel that = (IcebergBranchingAuditExperimenterModel) o;
    ...
    public String toString() {
        return "IcebergBranchingAuditExperimenterModel{" +
