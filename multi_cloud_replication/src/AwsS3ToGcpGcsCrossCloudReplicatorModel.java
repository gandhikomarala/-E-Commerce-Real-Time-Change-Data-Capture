...
/**
 * Enterprise CDC Lakehouse Model: AwsS3ToGcpGcsCrossCloudReplicatorModel.
 * Asynchronously replicates Iceberg data files between AWS S3 and Google Cloud Storage.
 */
public class AwsS3ToGcpGcsCrossCloudReplicatorModel implements Serializable {
    ...
    public AwsS3ToGcpGcsCrossCloudReplicatorModel() {
    ...
    public AwsS3ToGcpGcsCrossCloudReplicatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AwsS3ToGcpGcsCrossCloudReplicatorModel that = (AwsS3ToGcpGcsCrossCloudReplicatorModel) o;
    ...
    public String toString() {
        return "AwsS3ToGcpGcsCrossCloudReplicatorModel{" +
