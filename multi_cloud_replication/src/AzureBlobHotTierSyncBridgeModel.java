...
/**
 * Enterprise CDC Lakehouse Model: AzureBlobHotTierSyncBridgeModel.
 * Synchronizes real-time CDC delta changes with Azure Blob Storage Hot Archive tier.
 */
public class AzureBlobHotTierSyncBridgeModel implements Serializable {
    ...
    public AzureBlobHotTierSyncBridgeModel() {
    ...
    public AzureBlobHotTierSyncBridgeModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AzureBlobHotTierSyncBridgeModel that = (AzureBlobHotTierSyncBridgeModel) o;
    ...
    public String toString() {
        return "AzureBlobHotTierSyncBridgeModel{" +
