...
/**
 * Enterprise CDC Lakehouse Model: MultiRegionActiveActiveDataMeshModel.
 * Orchestrates multi-region active-active mesh routing for distributed CDC consumers.
 */
public class MultiRegionActiveActiveDataMeshModel implements Serializable {
    ...
    public MultiRegionActiveActiveDataMeshModel() {
    ...
    public MultiRegionActiveActiveDataMeshModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        MultiRegionActiveActiveDataMeshModel that = (MultiRegionActiveActiveDataMeshModel) o;
    ...
    public String toString() {
        return "MultiRegionActiveActiveDataMeshModel{" +
