...
/**
 * Enterprise CDC Lakehouse Model: ParquetTypeWideningCoercerModel.
 * Safely coerces integer and float primitive types during schema widening migrations.
 */
public class ParquetTypeWideningCoercerModel implements Serializable {
    ...
    public ParquetTypeWideningCoercerModel() {
    ...
    public ParquetTypeWideningCoercerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ParquetTypeWideningCoercerModel that = (ParquetTypeWideningCoercerModel) o;
    ...
    public String toString() {
        return "ParquetTypeWideningCoercerModel{" +
