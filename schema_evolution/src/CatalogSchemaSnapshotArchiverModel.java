...
/**
 * Enterprise CDC Lakehouse Model: CatalogSchemaSnapshotArchiverModel.
 * Maintains immutable Git-like commit history of all schema changes across Lakehouse tables.
 */
public class CatalogSchemaSnapshotArchiverModel implements Serializable {
    ...
    public CatalogSchemaSnapshotArchiverModel() {
    ...
    public CatalogSchemaSnapshotArchiverModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CatalogSchemaSnapshotArchiverModel that = (CatalogSchemaSnapshotArchiverModel) o;
    ...
    public String toString() {
        return "CatalogSchemaSnapshotArchiverModel{" +
