...
/**
 * Enterprise CDC Lakehouse Model: AvroSchemaCompatibilityValidatorModel.
 * Validates backward, forward, and full transitive schema compatibility across Confluent Registry.
 */
public class AvroSchemaCompatibilityValidatorModel implements Serializable {
    ...
    public AvroSchemaCompatibilityValidatorModel() {
    ...
    public AvroSchemaCompatibilityValidatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AvroSchemaCompatibilityValidatorModel that = (AvroSchemaCompatibilityValidatorModel) o;
    ...
    public String toString() {
        return "AvroSchemaCompatibilityValidatorModel{" +
