...
/**
 * Enterprise CDC Lakehouse Model: ProtobufDescriptorDriftDetectorModel.
 * Detects gRPC protobuf schema field additions, enum value mutations, and deprecation flags.
 */
public class ProtobufDescriptorDriftDetectorModel implements Serializable {
    ...
    public ProtobufDescriptorDriftDetectorModel() {
    ...
    public ProtobufDescriptorDriftDetectorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ProtobufDescriptorDriftDetectorModel that = (ProtobufDescriptorDriftDetectorModel) o;
    ...
    public String toString() {
        return "ProtobufDescriptorDriftDetectorModel{" +
