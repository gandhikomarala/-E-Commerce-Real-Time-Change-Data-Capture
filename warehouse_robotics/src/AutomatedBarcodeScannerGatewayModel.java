...
/**
 * Enterprise CDC Lakehouse Model: AutomatedBarcodeScannerGatewayModel.
 * Decodes 2D DataMatrix and QR parcel barcodes on high-speed sortation belts.
 */
public class AutomatedBarcodeScannerGatewayModel implements Serializable {
    ...
    public AutomatedBarcodeScannerGatewayModel() {
    ...
    public AutomatedBarcodeScannerGatewayModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AutomatedBarcodeScannerGatewayModel that = (AutomatedBarcodeScannerGatewayModel) o;
    ...
    public String toString() {
        return "AutomatedBarcodeScannerGatewayModel{" +
