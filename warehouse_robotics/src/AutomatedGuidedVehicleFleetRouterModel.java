...
/**
 * Enterprise CDC Lakehouse Model: AutomatedGuidedVehicleFleetRouterModel.
 * Routes autonomous warehouse AGV mobile robots to pick item totes based on orders.
 */
public class AutomatedGuidedVehicleFleetRouterModel implements Serializable {
    ...
    public AutomatedGuidedVehicleFleetRouterModel() {
    ...
    public AutomatedGuidedVehicleFleetRouterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AutomatedGuidedVehicleFleetRouterModel that = (AutomatedGuidedVehicleFleetRouterModel) o;
    ...
    public String toString() {
        return "AutomatedGuidedVehicleFleetRouterModel{" +
