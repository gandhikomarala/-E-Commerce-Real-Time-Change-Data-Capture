...
/**
 * Enterprise CDC Lakehouse Model: WarehouseLightToPickIndicatorSyncModel.
 * Synchronizes Pick-to-Light LED bin display states with warehouse picker terminals.
 */
public class WarehouseLightToPickIndicatorSyncModel implements Serializable {
    ...
    public WarehouseLightToPickIndicatorSyncModel() {
    ...
    public WarehouseLightToPickIndicatorSyncModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        WarehouseLightToPickIndicatorSyncModel that = (WarehouseLightToPickIndicatorSyncModel) o;
    ...
    public String toString() {
        return "WarehouseLightToPickIndicatorSyncModel{" +
