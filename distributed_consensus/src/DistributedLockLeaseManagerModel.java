...
/**
 * Enterprise CDC Lakehouse Model: DistributedLockLeaseManagerModel.
 * Acquires dynamic distributed leases for table partition compaction locks.
 */
public class DistributedLockLeaseManagerModel implements Serializable {
    ...
    public DistributedLockLeaseManagerModel() {
    ...
    public DistributedLockLeaseManagerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DistributedLockLeaseManagerModel that = (DistributedLockLeaseManagerModel) o;
    ...
    public String toString() {
        return "DistributedLockLeaseManagerModel{" +
