...
/**
 * Enterprise CDC Lakehouse Model: EpochWatermarkSynchronizationBarrierModel.
 * Synchronizes high-watermark LSN progress across multi-region clusters.
 */
public class EpochWatermarkSynchronizationBarrierModel implements Serializable {
    ...
    public EpochWatermarkSynchronizationBarrierModel() {
    ...
    public EpochWatermarkSynchronizationBarrierModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        EpochWatermarkSynchronizationBarrierModel that = (EpochWatermarkSynchronizationBarrierModel) o;
    ...
    public String toString() {
        return "EpochWatermarkSynchronizationBarrierModel{" +
