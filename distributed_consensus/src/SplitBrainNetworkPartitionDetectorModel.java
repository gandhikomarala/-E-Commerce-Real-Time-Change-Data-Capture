...
/**
 * Enterprise CDC Lakehouse Model: SplitBrainNetworkPartitionDetectorModel.
 * Detects cross-datacenter network partitions and enforces fencing tokens.
 */
public class SplitBrainNetworkPartitionDetectorModel implements Serializable {
    ...
    public SplitBrainNetworkPartitionDetectorModel() {
    ...
    public SplitBrainNetworkPartitionDetectorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SplitBrainNetworkPartitionDetectorModel that = (SplitBrainNetworkPartitionDetectorModel) o;
    ...
    public String toString() {
        return "SplitBrainNetworkPartitionDetectorModel{" +
