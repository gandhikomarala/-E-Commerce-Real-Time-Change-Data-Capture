...
/**
 * Enterprise CDC Lakehouse Model: TwoPhaseCommitTransactionCoordinatorModel.
 * Coordinates two-phase commit transactions between Kafka and Iceberg.
 */
public class TwoPhaseCommitTransactionCoordinatorModel implements Serializable {
    ...
    public TwoPhaseCommitTransactionCoordinatorModel() {
    ...
    public TwoPhaseCommitTransactionCoordinatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        TwoPhaseCommitTransactionCoordinatorModel that = (TwoPhaseCommitTransactionCoordinatorModel) o;
    ...
    public String toString() {
        return "TwoPhaseCommitTransactionCoordinatorModel{" +
