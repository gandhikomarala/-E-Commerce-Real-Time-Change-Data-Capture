...
/**
 * Enterprise CDC Lakehouse Model: DataCatalogApacheAtlasSynchronizerModel.
 * Synchronizes table schemas, classifications, and glossary terms with Apache Atlas.
 */
public class DataCatalogApacheAtlasSynchronizerModel implements Serializable {
    ...
    public DataCatalogApacheAtlasSynchronizerModel() {
    ...
    public DataCatalogApacheAtlasSynchronizerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DataCatalogApacheAtlasSynchronizerModel that = (DataCatalogApacheAtlasSynchronizerModel) o;
    ...
    public String toString() {
        return "DataCatalogApacheAtlasSynchronizerModel{" +
