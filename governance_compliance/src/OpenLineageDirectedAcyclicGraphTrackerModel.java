...
/**
 * Enterprise CDC Lakehouse Model: OpenLineageDirectedAcyclicGraphTrackerModel.
 * Constructs end-to-end dataset and job lineage graphs for audit and impact analysis.
 */
public class OpenLineageDirectedAcyclicGraphTrackerModel implements Serializable {
    ...
    public OpenLineageDirectedAcyclicGraphTrackerModel() {
    ...
    public OpenLineageDirectedAcyclicGraphTrackerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OpenLineageDirectedAcyclicGraphTrackerModel that = (OpenLineageDirectedAcyclicGraphTrackerModel) o;
    ...
    public String toString() {
        return "OpenLineageDirectedAcyclicGraphTrackerModel{" +
