...
/**
 * Enterprise CDC Lakehouse Model: AuditLogImmutableStorageManagerModel.
 * Maintains immutable WORM storage of all administrative CDC configuration changes.
 */
public class AuditLogImmutableStorageManagerModel implements Serializable {
    ...
    public AuditLogImmutableStorageManagerModel() {
    ...
    public AuditLogImmutableStorageManagerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AuditLogImmutableStorageManagerModel that = (AuditLogImmutableStorageManagerModel) o;
    ...
    public String toString() {
        return "AuditLogImmutableStorageManagerModel{" +
