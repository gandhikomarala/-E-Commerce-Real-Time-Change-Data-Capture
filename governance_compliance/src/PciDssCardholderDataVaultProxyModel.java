...
/**
 * Enterprise CDC Lakehouse Model: PciDssCardholderDataVaultProxyModel.
 * Isolates and encrypts PAN and CVV data in compliance with PCI-DSS 4.0 requirements.
 */
public class PciDssCardholderDataVaultProxyModel implements Serializable {
    ...
    public PciDssCardholderDataVaultProxyModel() {
    ...
    public PciDssCardholderDataVaultProxyModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PciDssCardholderDataVaultProxyModel that = (PciDssCardholderDataVaultProxyModel) o;
    ...
    public String toString() {
        return "PciDssCardholderDataVaultProxyModel{" +
