...
/**
 * Enterprise CDC Lakehouse Model: AutomatedDataDriftReporterModel.
 * Generates daily HTML and JSON reports summarizing column distributions and drift metrics.
 */
public class AutomatedDataDriftReporterModel implements Serializable {
    ...
    public AutomatedDataDriftReporterModel() {
    ...
    public AutomatedDataDriftReporterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        AutomatedDataDriftReporterModel that = (AutomatedDataDriftReporterModel) o;
    ...
    public String toString() {
        return "AutomatedDataDriftReporterModel{" +
