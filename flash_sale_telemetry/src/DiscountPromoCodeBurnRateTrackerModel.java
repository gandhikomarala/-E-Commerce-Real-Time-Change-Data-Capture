...
/**
 * Enterprise CDC Lakehouse Model: DiscountPromoCodeBurnRateTrackerModel.
 * Tracks remaining marketing promo code budget in real time to prevent over-allocation.
 */
public class DiscountPromoCodeBurnRateTrackerModel implements Serializable {
    ...
    public DiscountPromoCodeBurnRateTrackerModel() {
    ...
    public DiscountPromoCodeBurnRateTrackerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DiscountPromoCodeBurnRateTrackerModel that = (DiscountPromoCodeBurnRateTrackerModel) o;
    ...
    public String toString() {
        return "DiscountPromoCodeBurnRateTrackerModel{" +
