...
/**
 * Enterprise CDC Lakehouse Model: CartReservationExpiryReleaserModel.
 * Releases expired 15-minute shopping cart reservation locks back into available stock stream.
 */
public class CartReservationExpiryReleaserModel implements Serializable {
    ...
    public CartReservationExpiryReleaserModel() {
    ...
    public CartReservationExpiryReleaserModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CartReservationExpiryReleaserModel that = (CartReservationExpiryReleaserModel) o;
    ...
    public String toString() {
        return "CartReservationExpiryReleaserModel{" +
