...
/**
 * Enterprise CDC Lakehouse Model: PaymentGatewayFailoverSwitchModel.
 * Dynamically routes checkout authorizations across Stripe, Adyen, and PayPal during gateway outages.
 */
public class PaymentGatewayFailoverSwitchModel implements Serializable {
    ...
    public PaymentGatewayFailoverSwitchModel() {
    ...
    public PaymentGatewayFailoverSwitchModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PaymentGatewayFailoverSwitchModel that = (PaymentGatewayFailoverSwitchModel) o;
    ...
    public String toString() {
        return "PaymentGatewayFailoverSwitchModel{" +
