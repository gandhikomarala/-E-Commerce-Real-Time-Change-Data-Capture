...
/**
 * Enterprise CDC Lakehouse Model: WebSocketRealTimeMutationBroadcasterModel.
 * Streams filtered live CDC mutation events to subscribed frontend risk analyst consoles.
 */
public class WebSocketRealTimeMutationBroadcasterModel implements Serializable {
    ...
    public WebSocketRealTimeMutationBroadcasterModel() {
    ...
    public WebSocketRealTimeMutationBroadcasterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        WebSocketRealTimeMutationBroadcasterModel that = (WebSocketRealTimeMutationBroadcasterModel) o;
    ...
    public String toString() {
        return "WebSocketRealTimeMutationBroadcasterModel{" +
