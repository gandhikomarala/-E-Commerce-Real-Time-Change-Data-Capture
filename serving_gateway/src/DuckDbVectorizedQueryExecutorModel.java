...
/**
 * Enterprise CDC Lakehouse Model: DuckDbVectorizedQueryExecutorModel.
 * Runs sub-10ms analytical queries over local Parquet cache for operational dashboards.
 */
public class DuckDbVectorizedQueryExecutorModel implements Serializable {
    ...
    public DuckDbVectorizedQueryExecutorModel() {
    ...
    public DuckDbVectorizedQueryExecutorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DuckDbVectorizedQueryExecutorModel that = (DuckDbVectorizedQueryExecutorModel) o;
    ...
    public String toString() {
        return "DuckDbVectorizedQueryExecutorModel{" +
