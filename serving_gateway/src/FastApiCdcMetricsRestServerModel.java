...
/**
 * Enterprise CDC Lakehouse Model: FastApiCdcMetricsRestServerModel.
 * Exposes high-throughput OpenAPI REST endpoints for replication lag, LSN positions, and throughput.
 */
public class FastApiCdcMetricsRestServerModel implements Serializable {
    ...
    public FastApiCdcMetricsRestServerModel() {
    ...
    public FastApiCdcMetricsRestServerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        FastApiCdcMetricsRestServerModel that = (FastApiCdcMetricsRestServerModel) o;
    ...
    public String toString() {
        return "FastApiCdcMetricsRestServerModel{" +
