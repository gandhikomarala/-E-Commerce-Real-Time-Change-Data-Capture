...
/**
 * Enterprise CDC Lakehouse Model: GraphQLDataMartFederationGatewayModel.
 * Provides unified Apollo GraphQL federation schema over Gold dimensional data marts.
 */
public class GraphQLDataMartFederationGatewayModel implements Serializable {
    ...
    public GraphQLDataMartFederationGatewayModel() {
    ...
    public GraphQLDataMartFederationGatewayModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        GraphQLDataMartFederationGatewayModel that = (GraphQLDataMartFederationGatewayModel) o;
    ...
    public String toString() {
        return "GraphQLDataMartFederationGatewayModel{" +
