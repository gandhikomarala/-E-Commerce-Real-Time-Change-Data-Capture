...
/**
 * Enterprise CDC Lakehouse Model: OracleGoldenGateTrailFileParserModel.
 * Parses legacy Oracle GoldenGate trail file micro-batches for core ERP legacy migration.
 */
public class OracleGoldenGateTrailFileParserModel implements Serializable {
    ...
    public OracleGoldenGateTrailFileParserModel() {
    ...
    public OracleGoldenGateTrailFileParserModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OracleGoldenGateTrailFileParserModel that = (OracleGoldenGateTrailFileParserModel) o;
    ...
    public String toString() {
        return "OracleGoldenGateTrailFileParserModel{" +
