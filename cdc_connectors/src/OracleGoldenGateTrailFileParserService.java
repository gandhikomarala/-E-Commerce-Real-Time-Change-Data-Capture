...
/**
 * Enterprise Service Processor: OracleGoldenGateTrailFileParserService.
 * Parses legacy Oracle GoldenGate trail file micro-batches for core ERP legacy migration.
 */
public class OracleGoldenGateTrailFileParserService {

    private static final Logger LOGGER = Logger.getLogger(OracleGoldenGateTrailFileParserService.class.getName());
    private final Map<String, OracleGoldenGateTrailFileParserModel> storageCache = new ConcurrentHashMap<>();
    ...
    public OracleGoldenGateTrailFileParserService() {
        seedInitialCdcState();
    }
    ...
    private void seedInitialCdcState() {
        for (int i = 1; i <= 6; i++) {
            ...
            OracleGoldenGateTrailFileParserModel model = new OracleGoldenGateTrailFileParserModel(
                mutId,
    ...
    public OracleGoldenGateTrailFileParserModel processIncomingMutation(OracleGoldenGateTrailFileParserModel mutation) {
        long startNano = System.nanoTime();
        if (mutation == null || mutation.getMutationId() == null) {
            LOGGER.log(Level.WARNING, "Rejected null CDC mutation payload in OracleGoldenGateTrailFileParserService");
    ...
    public Optional<OracleGoldenGateTrailFileParserModel> findById(String mutationId) {
        if (mutationId == null) return Optional.empty();
        return Optional.ofNullable(storageCache.get(mutationId));
    }

    public List<OracleGoldenGateTrailFileParserModel> listAll() {
        return new ArrayList<>(storageCache.values());
    }

    public List<OracleGoldenGateTrailFileParserModel> listByMedallionLayer(String layer) {
    ...
    public boolean updateMedallionStage(String mutationId, String newLayer) {
        OracleGoldenGateTrailFileParserModel model = storageCache.get(mutationId);
        if (model != null) {
