...
/**
 * Enterprise CDC Lakehouse Model: MongoChangeStreamResumeTokenSyncModel.
 * Streams MongoDB 4.4+ change streams with resume token persistent checkpointing.
 */
public class MongoChangeStreamResumeTokenSyncModel implements Serializable {
    ...
    public MongoChangeStreamResumeTokenSyncModel() {
    ...
    public MongoChangeStreamResumeTokenSyncModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        MongoChangeStreamResumeTokenSyncModel that = (MongoChangeStreamResumeTokenSyncModel) o;
    ...
    public String toString() {
        return "MongoChangeStreamResumeTokenSyncModel{" +
