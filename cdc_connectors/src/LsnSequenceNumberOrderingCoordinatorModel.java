...
/**
 * Enterprise CDC Lakehouse Model: LsnSequenceNumberOrderingCoordinatorModel.
 * Guarantees strict linearizable causal ordering of mutations using WAL Log Sequence Numbers (LSN).
 */
public class LsnSequenceNumberOrderingCoordinatorModel implements Serializable {
    ...
    public LsnSequenceNumberOrderingCoordinatorModel() {
    ...
    public LsnSequenceNumberOrderingCoordinatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        LsnSequenceNumberOrderingCoordinatorModel that = (LsnSequenceNumberOrderingCoordinatorModel) o;
    ...
    public String toString() {
        return "LsnSequenceNumberOrderingCoordinatorModel{" +
