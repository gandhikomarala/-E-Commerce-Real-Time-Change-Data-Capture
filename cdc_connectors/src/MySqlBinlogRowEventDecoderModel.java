...
/**
 * Enterprise CDC Lakehouse Model: MySqlBinlogRowEventDecoderModel.
 * Consumes MySQL binary row-level mutations (TABLE_MAP, WRITE_ROWS, UPDATE_ROWS, DELETE_ROWS).
 */
public class MySqlBinlogRowEventDecoderModel implements Serializable {
    ...
    public MySqlBinlogRowEventDecoderModel() {
    ...
    public MySqlBinlogRowEventDecoderModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        MySqlBinlogRowEventDecoderModel that = (MySqlBinlogRowEventDecoderModel) o;
    ...
    public String toString() {
        return "MySqlBinlogRowEventDecoderModel{" +
