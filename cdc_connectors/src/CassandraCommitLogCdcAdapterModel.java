...
/**
 * Enterprise CDC Lakehouse Model: CassandraCommitLogCdcAdapterModel.
 * Captures commitlog mutations across distributed Apache Cassandra cluster partition keys.
 */
public class CassandraCommitLogCdcAdapterModel implements Serializable {
    ...
    public CassandraCommitLogCdcAdapterModel() {
    ...
    public CassandraCommitLogCdcAdapterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CassandraCommitLogCdcAdapterModel that = (CassandraCommitLogCdcAdapterModel) o;
    ...
    public String toString() {
        return "CassandraCommitLogCdcAdapterModel{" +
