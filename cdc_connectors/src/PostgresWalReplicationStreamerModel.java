...
/**
 * Enterprise CDC Lakehouse Model: PostgresWalReplicationStreamerModel.
 * Extracts PostgreSQL Write-Ahead Log (WAL) logical decoding events via pgoutput plugin.
 */
public class PostgresWalReplicationStreamerModel implements Serializable {
    ...
    public PostgresWalReplicationStreamerModel() {
    ...
    public PostgresWalReplicationStreamerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PostgresWalReplicationStreamerModel that = (PostgresWalReplicationStreamerModel) o;
    ...
    public String toString() {
        return "PostgresWalReplicationStreamerModel{" +
