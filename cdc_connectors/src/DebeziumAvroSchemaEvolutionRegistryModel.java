...
/**
 * Enterprise CDC Lakehouse Model: DebeziumAvroSchemaEvolutionRegistryModel.
 * Synchronizes dynamic table column additions and schema mutations with Confluent Schema Registry.
 */
public class DebeziumAvroSchemaEvolutionRegistryModel implements Serializable {
    ...
    public DebeziumAvroSchemaEvolutionRegistryModel() {
    ...
    public DebeziumAvroSchemaEvolutionRegistryModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DebeziumAvroSchemaEvolutionRegistryModel that = (DebeziumAvroSchemaEvolutionRegistryModel) o;
    ...
    public String toString() {
        return "DebeziumAvroSchemaEvolutionRegistryModel{" +
