...
/**
 * Enterprise CDC Lakehouse Model: KafkaConnectDistributedWorkerClusterModel.
 * Manages Kafka Connect distributed worker cluster configurations, task rebalancing, and offsets.
 */
public class KafkaConnectDistributedWorkerClusterModel implements Serializable {
    ...
    public KafkaConnectDistributedWorkerClusterModel() {
    ...
    public KafkaConnectDistributedWorkerClusterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        KafkaConnectDistributedWorkerClusterModel that = (KafkaConnectDistributedWorkerClusterModel) o;
    ...
    public String toString() {
        return "KafkaConnectDistributedWorkerClusterModel{" +
