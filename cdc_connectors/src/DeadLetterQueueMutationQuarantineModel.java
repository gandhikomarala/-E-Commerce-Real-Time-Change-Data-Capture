...
/**
 * Enterprise CDC Lakehouse Model: DeadLetterQueueMutationQuarantineModel.
 * Quarantines malformed, unparseable, or schema-violating CDC payloads into isolated DLQ topic.
 */
public class DeadLetterQueueMutationQuarantineModel implements Serializable {
    ...
    public DeadLetterQueueMutationQuarantineModel() {
    ...
    public DeadLetterQueueMutationQuarantineModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        DeadLetterQueueMutationQuarantineModel that = (DeadLetterQueueMutationQuarantineModel) o;
    ...
    public String toString() {
        return "DeadLetterQueueMutationQuarantineModel{" +
