...
/**
 * Enterprise CDC Lakehouse Model: SurrogateKeySequenceGeneratorModel.
 * Generates 64-bit monotonically increasing surrogate keys for dimension table joins.
 */
public class SurrogateKeySequenceGeneratorModel implements Serializable {
    ...
    public SurrogateKeySequenceGeneratorModel() {
    ...
    public SurrogateKeySequenceGeneratorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SurrogateKeySequenceGeneratorModel that = (SurrogateKeySequenceGeneratorModel) o;
    ...
    public String toString() {
        return "SurrogateKeySequenceGeneratorModel{" +
