...
/**
 * Enterprise CDC Lakehouse Model: EffectiveDateRangeOverlapValidatorModel.
 * Guarantees zero temporal overlap between valid_from and valid_to timestamps across dimension rows.
 */
public class EffectiveDateRangeOverlapValidatorModel implements Serializable {
    ...
    public EffectiveDateRangeOverlapValidatorModel() {
    ...
    public EffectiveDateRangeOverlapValidatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        EffectiveDateRangeOverlapValidatorModel that = (EffectiveDateRangeOverlapValidatorModel) o;
    ...
    public String toString() {
        return "EffectiveDateRangeOverlapValidatorModel{" +
