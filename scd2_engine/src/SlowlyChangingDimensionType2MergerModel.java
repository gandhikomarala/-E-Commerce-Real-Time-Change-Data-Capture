...
/**
 * Enterprise CDC Lakehouse Model: SlowlyChangingDimensionType2MergerModel.
 * Automates row retirement and new active version insertion for SCD Type 2 dimension tables.
 */
public class SlowlyChangingDimensionType2MergerModel implements Serializable {
    ...
    public SlowlyChangingDimensionType2MergerModel() {
    ...
    public SlowlyChangingDimensionType2MergerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SlowlyChangingDimensionType2MergerModel that = (SlowlyChangingDimensionType2MergerModel) o;
    ...
    public String toString() {
        return "SlowlyChangingDimensionType2MergerModel{" +
