...
/**
 * Enterprise CDC Lakehouse Model: PointInTimeHistoricalStateReconstructorModel.
 * Reconstructs exact customer and product dimension attributes as of any arbitrary historical timestamp.
 */
public class PointInTimeHistoricalStateReconstructorModel implements Serializable {
    ...
    public PointInTimeHistoricalStateReconstructorModel() {
    ...
    public PointInTimeHistoricalStateReconstructorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        PointInTimeHistoricalStateReconstructorModel that = (PointInTimeHistoricalStateReconstructorModel) o;
    ...
    public String toString() {
        return "PointInTimeHistoricalStateReconstructorModel{" +
