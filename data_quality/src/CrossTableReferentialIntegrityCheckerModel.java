...
/**
 * Enterprise CDC Lakehouse Model: CrossTableReferentialIntegrityCheckerModel.
 * Validates that every order_item CDC record references an existing product SKU in Silver layer.
 */
public class CrossTableReferentialIntegrityCheckerModel implements Serializable {
    ...
    public CrossTableReferentialIntegrityCheckerModel() {
    ...
    public CrossTableReferentialIntegrityCheckerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        CrossTableReferentialIntegrityCheckerModel that = (CrossTableReferentialIntegrityCheckerModel) o;
    ...
    public String toString() {
        return "CrossTableReferentialIntegrityCheckerModel{" +
