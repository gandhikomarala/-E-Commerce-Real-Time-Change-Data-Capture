...
/**
 * Enterprise CDC Lakehouse Model: NullValueIntegrityViolationAuditorModel.
 * Blocks CDC merges containing NULL values in non-nullable business primary or foreign keys.
 */
public class NullValueIntegrityViolationAuditorModel implements Serializable {
    ...
    public NullValueIntegrityViolationAuditorModel() {
    ...
    public NullValueIntegrityViolationAuditorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        NullValueIntegrityViolationAuditorModel that = (NullValueIntegrityViolationAuditorModel) o;
    ...
    public String toString() {
        return "NullValueIntegrityViolationAuditorModel{" +
