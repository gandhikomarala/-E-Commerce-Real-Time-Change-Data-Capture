...
/**
 * Enterprise CDC Lakehouse Model: SodaCoreAnomalyDetectionMonitorModel.
 * Continuously tracks distribution anomalies in order totals, discount percentages, and row counts.
 */
public class SodaCoreAnomalyDetectionMonitorModel implements Serializable {
    ...
    public SodaCoreAnomalyDetectionMonitorModel() {
    ...
    public SodaCoreAnomalyDetectionMonitorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        SodaCoreAnomalyDetectionMonitorModel that = (SodaCoreAnomalyDetectionMonitorModel) o;
    ...
    public String toString() {
        return "SodaCoreAnomalyDetectionMonitorModel{" +
