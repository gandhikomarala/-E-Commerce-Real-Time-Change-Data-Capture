...
/**
 * Enterprise CDC Lakehouse Model: GreatExpectationsContractEnforcerModel.
 * Runs automated suite of statistical data assertions before promoting Silver records to Gold.
 */
public class GreatExpectationsContractEnforcerModel implements Serializable {
    ...
    public GreatExpectationsContractEnforcerModel() {
    ...
    public GreatExpectationsContractEnforcerModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        GreatExpectationsContractEnforcerModel that = (GreatExpectationsContractEnforcerModel) o;
    ...
    public String toString() {
        return "GreatExpectationsContractEnforcerModel{" +
