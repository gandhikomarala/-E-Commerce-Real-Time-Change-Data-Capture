"""
Real-Time Python CDC Processing Worker: OpenTelemetryContextInjectorFilter.
...
logger = logging.getLogger("OpenTelemetryContextInjectorFilterProcessor")

class OpenTelemetryContextInjectorFilterProcessor:
    ...
    def process_cdc_event(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[OpenTelemetryContextInjectorFilter] Processed mutation {mutation_id} for {table}: Layer={layer}, Latency={elapsed_ms:.2f}ms")
