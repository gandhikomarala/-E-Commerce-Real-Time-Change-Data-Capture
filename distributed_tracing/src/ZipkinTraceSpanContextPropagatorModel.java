...
/**
 * Enterprise CDC Lakehouse Model: ZipkinTraceSpanContextPropagatorModel.
 * Propagates B3 distributed trace headers across asynchronous CDC worker queues.
 */
public class ZipkinTraceSpanContextPropagatorModel implements Serializable {
    ...
    public ZipkinTraceSpanContextPropagatorModel() {
    ...
    public ZipkinTraceSpanContextPropagatorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        ZipkinTraceSpanContextPropagatorModel that = (ZipkinTraceSpanContextPropagatorModel) o;
    ...
    public String toString() {
        return "ZipkinTraceSpanContextPropagatorModel{" +
