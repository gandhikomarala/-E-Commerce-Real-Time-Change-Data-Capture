...
/**
 * Enterprise CDC Lakehouse Model: OpenTelemetryContextInjectorFilterModel.
 * Injects traceparent W3C context headers into outgoing Kafka record metadata.
 */
public class OpenTelemetryContextInjectorFilterModel implements Serializable {
    ...
    public OpenTelemetryContextInjectorFilterModel() {
    ...
    public OpenTelemetryContextInjectorFilterModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        OpenTelemetryContextInjectorFilterModel that = (OpenTelemetryContextInjectorFilterModel) o;
    ...
    public String toString() {
        return "OpenTelemetryContextInjectorFilterModel{" +
