...
/**
 * Enterprise CDC Lakehouse Model: EndToEndLatencySlaBreachDetectorModel.
 * Calculates cumulative end-to-end latency and flags SLA violations > 500ms.
 */
public class EndToEndLatencySlaBreachDetectorModel implements Serializable {
    ...
    public EndToEndLatencySlaBreachDetectorModel() {
    ...
    public EndToEndLatencySlaBreachDetectorModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        EndToEndLatencySlaBreachDetectorModel that = (EndToEndLatencySlaBreachDetectorModel) o;
    ...
    public String toString() {
        return "EndToEndLatencySlaBreachDetectorModel{" +
