...
/**
 * Enterprise CDC Lakehouse Model: KafkaConsumerLagAlertPrometheusSinkModel.
 * Exports Kafka consumer group lag metrics into Prometheus TSDB format.
 */
public class KafkaConsumerLagAlertPrometheusSinkModel implements Serializable {
    ...
    public KafkaConsumerLagAlertPrometheusSinkModel() {
    ...
    public KafkaConsumerLagAlertPrometheusSinkModel(String mutationId, String sourceTable, String operationType,
    ...
    public boolean equals(Object o) {
        ...
        KafkaConsumerLagAlertPrometheusSinkModel that = (KafkaConsumerLagAlertPrometheusSinkModel) o;
    ...
    public String toString() {
        return "KafkaConsumerLagAlertPrometheusSinkModel{" +
